  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="overlay absolute w-full h-[650px] max-h-[650px] lg:h-full">

        </div>
        <div className="absolute mx-7 lg:mx-20 flex flex-col space-y-3">
          <span className="uppercase tracking-widest lg:font-medium leading-7 text-white text-xl lg:text-2xl drop-shadow-md">
            INTRODUCING
          </span>
          <h1 className="text-3xl lg:text-6xl font-bold text-white drop-shadow-lg">
            Pool Paint Screen LLC
          </h1>
          <h2 className="uppercase drop-shadow-lg font-medium pb-10 tracking-wider lg:font-normal leading-7 text-white text-xl lg:text-2xl">
