...
const FeaturesSection = () => {
    ...
    const features = [
    {
     ...
     linkWeb: "/materials/pool-cage-paints"
    },
    {
      id: 2,
     ...
     linkWeb: "/materials/pool-cage-screens"
    },
  ...
  return (
    <>
      ...
      <div className="flex mb-5 space-y-14 lg:space-y-1  mt-14 flex-col">
        {features.map((feature: any)=> <FeatureCard linkWeb={feature.linkWeb} orientation={feature.orientation} image={feature.imageUrl} resume={feature.resume} title={feature.title} key={feature.id}/>)}
      </div>
    </>
  );
};
