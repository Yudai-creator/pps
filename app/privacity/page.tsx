      ...
      <div className="mx-auto max-w-7xl px-6 py-10 sm:py-8 lg:px-8 lg:py-8">
        <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
          <dl className="mt-12 space-y-6 divide-y divide-gray-900/10">
            <div>
              {" "}
              <h1 className="text-slate-800 font-semibold text-lg">Cookies Policy</h1>
              <p className="text-slate-800">Last updated: March 28, 2023</p>
              ...
              <h2 className="text-slate-800 font-semibold mt-4">Interpretation and Definitions</h2>
              <h3 className="text-slate-800">Interpretation</h3>
              <p className="text-slate-800">
              ...
              <h3 className="text-slate-800 font-semibold mt-4">Definitions</h3>
              <p className="text-slate-800">For the purposes of this Cookies Policy:</p>
              <ul className="list-disc">
                <li className="text-slate-800">
                  Company (referred to as either "the Company", "We", "Us" or
                  "Our" in this Cookies Policy) refers to Pool Paint Screen LLC,
                  1330 Grande Blvd Unit 204 Sarasota FL 34232.
                </li>
                <li className="text-slate-800">
                ...
                <li className="text-slate-800">
                  Website refers to Pool Paint Screen LLC, accessible from{" "}
                  <Link href="https://www.poolpaintscreen.com">
                    https://www.poolpaintscreen.com
                  </Link>
                </li>
                <li className="text-slate-800">
              ...
              <h2 className="text-slate-800 font-semibold mt-4">The use of the Cookies</h2>
              <h3 className="text-slate-800">Type of Cookies We Use</h3>
              <p className="text-slate-800">
              ...
              <h4 className="text-slate-800 font-semibold">Necessary / Essential Cookies</h4>
              <ul className="text-slate-800 list-disc">
                <li className="text-slate-800">Type: Session Cookies</li>
              ...
              <h4 className="text-slate-800 font-semibold mt-4">Cookies Policy / Notice Acceptance Cookies</h4>
              <ul className="text-slate-800 list-disc">
              ...
              <h4 className="text-slate-800 font-semibold mt-4">Functionality Cookies</h4>
              <ul className="text-slate-800 list-disc">
                <li>Type: Persistent Cookies</li>
                <li>Administered by: Us</li>
                <li>
              ...
              <h4 className="text-slate-800 font-semibold mt-4">Tracking and Performance Cookies</h4>
              <ul className="text-slate-800 list-disc">
                <li>Type: Persistent Cookies</li>
              ...
              <h4 className="text-slate-800 font-semibold mt-4">Targeting and Advertising Cookies</h4>
              <ul className="text-slate-800 list-disc">
                <li>Type: Persistent Cookies</li>
                <li>Administered by: Third-Parties</li>
                <li>
              ...
              <h4 className="text-slate-800 font-semibold mt-4">Social Media Cookies</h4>
              <ul className="text-slate-800 list-disc">
                <li>Type: Persistent Cookies</li>
                <li>Administered by: Third-Parties</li>
                <li>
              ...
              <h2 className="text-slate-800 font-semibold mt-4">Your Choices Regarding Cookies</h2>
              <p className="text-slate-800">
              ...
              <p className="text-slate-800">
                ...
                <Link href="https://support.google.com/accounts/answer/32050">
              ...
              <h2 className="text-slate-800 font-semibold">More Information about Cookies</h2>
              <p className="text-slate-800">
                You can learn more about cookies here:{" "}
                <Link href="https://www.termsfeed.com/blog/all-about-cookies/">
...
export default PrivacityTermPage;
